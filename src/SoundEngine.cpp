...
Sound::Sound(float percent) : _volume(percent)
{

}

Sound::Sound(Sound const &copy) : _volume(1)
{
	*this = copy;
}

Sound const & Sound::operator=(Sound const &copy)
{
...
void	Sound::setVolume(float percent)
{
	if (percent < 0)
		percent = 0;
	else if (percent > 1)
